      ...
      <section className="resident__body">
        ...
        <ul className="resident__stats">
          <li className="resident__stat__item">
            ...
            <span className="resident__stat__label">{resident?.species}</span>
          </li>
          <li className="resident__stat__item">
            <span className="resident__stat__label">Origin</span>
            <span className="resident__stat__label">{resident?.origin.name}</span>
          </li>
          <li className="resident__stat__item">
            <span className="resident__stat__label">Eppisodes where appear</span>
            <span className="resident__stat__label">{resident?.episode.length}</span>
          </li>
        </ul>
      </section>
    </article>
